...
def begin_process_from_attachment_endpoint(
    attachment_id: str,
    mode: str = Query(default="auto"),
    parser: str = Query(default="auto"),
):
    return create_job_from_attachment(attachment_id=attachment_id, requested_mode=mode, requested_parser=parser)
