...
from app.admin.service import get_ui_settings
from app.auth.deps import get_current_user, require_admin, require_evaluator_or_admin
...
@router.get("/login")
def login_page():
    static_file = Path(__file__).resolve().parents[1] / "static" / "login.html"
